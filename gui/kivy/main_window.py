...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'CMM')
    ...
    def __init__(self, **kwargs):
        ...
        title = _('Commercium Electrum App')
    ...
    def load_wallet_by_name(self, path):
        ...
        if wallet:
            ...
            Logger.debug('Commercium Electrum: Wallet not found. Launching install wizard')
    ...
    def notify(self, message):
        try:
            ...
            notification.notify('Electrum', message,
                            app_icon=icon, app_name='Commercium Electrum')
        except ImportError:
